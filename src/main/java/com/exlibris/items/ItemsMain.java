...
public class ItemsMain {
    ...
    public static class ItemJob implements Job {

        public void execute(JobExecutionContext context) throws JobExecutionException {

            logger.info("ItemJob executed");

            for (String institution : getInstitutionsList()) {
                mergeItemsWithSCF(institution);
            }

        }

        private void mergeItemsWithSCF(String institution) {
            try {
                ...
                for (File xmlFile : xmlFiles) {
                    ...
                    for (Record record : records) {
                        ...
                        for (VariableField variableField : variableFields) {
                            ...
                            Method method = Class.forName("com.exlibris.items.ItemsHandler")
                                    .getMethod(methodName, ItemData.class);
        ...
        private String getNetworkNumber(List<VariableField> variableFields) {
            for (VariableField variableField : variableFields) {
        ...
        private List<String> getInstitutionsList() {
